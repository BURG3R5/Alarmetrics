...
interface RecordDao {
    ...
    @Query("SELECT a.*, SUM(r.lastSnooze - r.firstSnooze) as totalSnoozeTime, COUNT(r.id) as recordsCount FROM alarms a LEFT JOIN records r ON a.id = r.alarmId GROUP BY a.id")
